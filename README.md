...
![test status](https://github.com/swarnimarun/cadvisor/workflows/Test/badge.svg)
...
```
VERSION=v0.49.1 # use the latest release version from https://github.com/swarnimarun/cadvisor/releases
sudo docker run \
  --volume=/:/rootfs:ro \
